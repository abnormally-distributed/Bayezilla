...
#' @examples
#' genRidge()
genRidge = function(formula, data, family = "gaussian", lambda.prior = "dmouch", log_lik = FALSE, iter= 8000, warmup=1000, adapt=1000, chains=4, thin=1, method = "rjparallel", cl = makeCluster(2), ...){
