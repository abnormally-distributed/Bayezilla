...
#' apcGlm()
#' 
apcGlm = function(formula, data, family = "gaussian", lower = -10, upper = 10, log_lik = FALSE, iter=10000, warmup=2500, adapt=7500, chains=4, thin=1, method = "parallel", cl = makeCluster(2), ...)
{
