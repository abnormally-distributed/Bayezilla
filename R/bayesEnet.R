...
#' bayesEnet()
#'
bayesEnet  = function(formula, data, family = "gaussian", lambda.prior = "dmouch", log_lik = FALSE, iter=10000, warmup=1000, adapt=2000, chains=4, thin=1, method = "rjparallel", cl = makeCluster(2), ...){
