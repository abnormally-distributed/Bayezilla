...
#' extLASSO()
#'
extLASSO  = function(formula, data, family = "normal", eta_prior = "classic", local_u = 2, top_u = 10000, log_lik = FALSE, iter=10000, warmup = 10000, adapt=15000, chains=4, thin = 3, method = "parallel", cl = makeCluster(2), ...){
