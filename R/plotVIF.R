...
#' If the VIFs are all rather low, then using \code{\link[Bayezilla]{glmFlat}} is safe. If some are higher,
#' you may wish to use \code{\link[Bayezilla]{glmBayes}} instead which results in ridge-regression like 
#' regularization. \cr
#' \cr
