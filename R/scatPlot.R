...
scatPlot = function(formula, data = NULL, xlab="default", ylab="default", col = "blues", smooth = FALSE, regline = TRUE, ci = FALSE, conf.level = 0.90, font = "serif"){
  ...
  par(family = font)
  plot(x = x, y = y, xlab = xlab, ylab = ylab, xlim=xrange, xaxt = "n", yaxt = "n", lwd = 1.225, cex = 1.25, lty = 1, pch = 21, bty="l", family = font, col = ColorScheme[2], bg = ColorScheme[1], cex.lab=1.25)
