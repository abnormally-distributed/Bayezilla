...
P <- 8
#True betas
betas = c(1.2927551, .11, .453434, -.51, .95, -1.18113776, -0.9273929, 0.71721614) 
...
X = X + matrix(brms::rstudent_t((N * P)/4 , 16, .0, .0001), N, P)
...
```{r echo=FALSE}
post_summary(out)
coefs1 = post_summary(out)$estimate[2:9]
```
...
```{r}
post_summary(out2)
coefs2 = post_summary(out2)$estimate[2:9]
```
...
```{r}
post_summary(out3)
coefs3 = post_summary(out3)$estimate[2:9]
```
...
```{r}
post_summary(out4)
coefs4 = post_summary(out4)$estimate[2:9]
```
...
```{r}
post_summary(out5)
coefs5 = post_summary(out5)$estimate[2:9]
```
...
```{r}
true.betas = round(c(1.2927551, .11, .453434, -.51, .95, -1.18113776, -0.9273929, 0.71721614) , 3)
